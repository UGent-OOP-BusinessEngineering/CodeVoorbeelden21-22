...
public class TimeBook {
    ...
    //employee j on day i.
    private int[] weekHours; // de sommen worden nog eens ie aparte array opgeslagen
    //weekHours[i] has the weeks
    //hours worked for employee i + 1.
    private int[] dayHours;  // idem lijn 13.
    //dayHours[i] has the total hours
    ...
    public TimeBook(int theNumberOfEmployees) // constructor
    {
    ...
    public void setHours ()  //This is a stub. -> voorbeeld.
    {
        hours[0][0] = 8;
        hours[0][1] = 0;
        hours[0][2] = 9;
    ...
    private String getDayName (int day)// Deze methode zet de nummers om in Strings.
    {
        String dayName = null;
        switch (day)
        {
